...
const Dashboard = () => {
  ...
  const renderIncidencias = (estado) => {
    return incidencias
      ...
      .map(incidencia => (
        <li key={incidencia.ID} className={`p-4 rounded-lg ${getBackgroundColor(incidencia.Estado)}`}>
          <h3 className="text-lg font-semibold text-gray-800">{incidencia.Asunto}</h3>
          <p className="text-gray-600 mt-2">{incidencia.Descripción}</p>
            ...
            <div className="bg-white rounded-lg shadow-xl overflow-hidden">
              <div className="px-10 py-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h2 className="text-xl font-semibold text-gray-700 mb-4">Incidencias Pendientes</h2>
                    <ul className="space-y-4">
                      {renderIncidencias('pendiente')}
                    </ul>
                  </div>
                  <div>
                    <h2 className="text-xl font-semibold text-gray-700 mb-4">Incidencias En Progreso</h2>
                    <ul className="space-y-4">
                      {renderIncidencias('en progreso')}
                    </ul>
                  </div>
                  <div>
                    <h2 className="text-xl font-semibold text-gray-700 mb-4">Incidencias Resueltas</h2>
                    <ul className="space-y-4">
